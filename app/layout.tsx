  ...
  return (
    <html lang="en">
      <body className={inter.className}>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex justify-between h-16">
              ...
              <div className="flex items-center gap-6">
                ...
                <Link href="/signup" className="bg-blue-900 hover:bg-blue-800 text-white px-4 py-2 rounded-md text-sm font-medium">
                  Join Now
                </Link>
              </div>
            </div>
        ...
        {children}
        <footer className="bg-gray-50 border-t mt-20 py-10 text-center text-sm text-gray-500">
